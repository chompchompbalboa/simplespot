...
/**
* This module renders a div with a general purpose of acting as a container
* for children modules.
*
...
var BasicContainer = React.createClass({
    ...
    */
    render: function() {
        ...
        let builtContents = utils.loader.loadModules(keychain, contents, utils);
        return (
            <div style={style}>
                {builtContents}
            </div>
...
module.exports = Radium(BasicContainer);